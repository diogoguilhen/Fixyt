...
//craido o construtor para que seja enviado para o databse.
    ...
    public CadastroMotorista(String veiculoTipo, String veiculoMarca, String veiculoModelo, String veiculoAnoFabricacao, String veiculoAnoModelo, String veiculoPlaca, String veiculoRenavam, String veiculoKilometragem, String veiculoCor) {
    ...
    public CadastroMotorista(String vLatitude, String vLongitude, String pontoReferencia) {
